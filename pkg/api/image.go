...
func UpdateImages(rs io.ReadSeeker, rd io.Reader, w io.Writer, objNr, pageNr int, id string, conf *model.Configuration, knownImageConfig *model.KnownImageConfig) error {
...
func UpdateImagesFile(inFile, imageFile, outFile string, objNr, pageNr int, id string, conf *model.Configuration, knownImageConfig *model.KnownImageConfig) (err error) {
	...
	return UpdateImages(f0, f1, f2, objNr, pageNr, id, conf, knownImageConfig)
}
